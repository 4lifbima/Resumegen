      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Alif Bima Pradana"}
              </Heading>
              <Text color={"gray.500"}>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "alif67916@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+6282291383797"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Bonebolango"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={"medium"}>
                        {degree ? degree : "Universitas Negeri Gorontalo"}
                      </Text>
                      <Text fontSize={"sm"}>
                        {school ? school : "Informatics engineering"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        <Text>
                          {startYr ? startYr : 2023} - {endYr ? endYr : 2024}
                        </Text>
                        <Text>{grade ? grade : "3,7 IPK"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"} as="p">
                        {desc
                          ? desc
                          : "Create the front page of the details section of the kslung.com website"}
                      </Text>
                    </VStack>
                  );
                })}
